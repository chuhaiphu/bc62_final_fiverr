    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white rounded-lg p-6 z-10 w-11/12 md:w-3/4 lg:w-1/3 relative">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            <label htmlFor="nguoiTao" className="block text-sm font-medium leading-6 text-gray-900">
              Creator ID
            </label>
            <input
          ...
          <div>
            ...
            <input
              {...register('maChiTietLoaiCongViec', { required: true, valueAsNumber: true })}
              type="number"
          ...
          <div>
            ...
            <select
              {...register('saoCongViec', { required: true, valueAsNumber: true })}
              id="saoCongViec"
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
            >
